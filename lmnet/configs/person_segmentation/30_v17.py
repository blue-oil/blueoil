...
from lmnet.networks.segmentation.v17 import LmSegnetV1Quantize
...
IS_PRETRAIN = False
PRETRAIN_VARS = []
PRETRAIN_DIR = "saved/person_segmentation/7_v5/checkpoints"
PRETRAIN_FILE = "save.ckpt-230000"
...
NETWORK.OPTIMIZER_KWARGS = {"learning_rate": 1e-3}
# NETWORK.LEARNING_RATE_FUNC = tf.train.piecewise_constant
# _epoch_steps = int(28280 / BATCH_SIZE)
# NETWORK.LEARNING_RATE_KWARGS = {
#     "values": [1e-3, 1e-4, 1e-5, ],
#     "boundaries": [_epoch_steps * 30, _epoch_steps * 40, ],
# }
...
NETWORK.USE_LOSSS_WEIGHT = False
NETWORK.AUXILIARY_WEIGHT = 0.5
