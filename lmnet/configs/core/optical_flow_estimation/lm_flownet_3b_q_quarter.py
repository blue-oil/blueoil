...
NETWORK_CLASS = LmFlowNetQuantized
CONV_DEPTH = 3
DATASET_CLASS = FlyingChairs
SLICE_STEP = 4
IMAGE_SIZE = [384 // SLICE_STEP, 512 // SLICE_STEP]
DEFAULT_CONV_CHANNEL = [16, 128, 256, 512, 512, 1024, 1024, 1024]
...
NETWORK.DEFAULT_CONV_CHANNEL = DEFAULT_CONV_CHANNEL
...
NETWORK.QUANTIZE_ACTIVATION_FIRST_LAYER = True
...
DATASET.TRAIN_QUEUE_SIZE = 10000
