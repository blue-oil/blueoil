...
from lmnet.networks.segmentation.v21 import LmSegnetV1Quantize
...
# _epoch_steps = int(367 / BATCH_SIZE)
# NETWORK.LEARNING_RATE_KWARGS = {
#     "values": [1e-4, 1e-1, 1e-2, 1e-3, ],
#     "boundaries": [_epoch_steps, _epoch_steps * 200, _epoch_steps * 300, ],
# }
