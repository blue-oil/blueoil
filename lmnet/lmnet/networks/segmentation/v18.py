...
class LmSegnetV1(Base):
    ...
    def spatial(self, x):
        with tf.variable_scope("spatial"):
            ...
            x = self.lmnet_block('conv_2', x, 96, 3, activation=tf.nn.relu)
    ...
    def context(self, x):
        with tf.variable_scope("context"):
            ...
            with tf.variable_scope("block_2"):
                ...
                x = self.lmnet_block('conv_2', x, 256, 1, activation=tf.nn.relu)
    ...
    def base(self, images, is_training, *args, **kwargs):
        ...
        cx_1 = self._depth_to_space(name="d2s_1", inputs=cx_16, block_size=4)
        cx_2 = self._depth_to_space(name="d2s_2", inputs=cx_32, block_size=8)
    ...
    def post_process(self, output):
        with tf.name_scope("post_process"):
            ...
            x = tf.image.resize_bilinear(output, [h*4, w*4])
            return x
