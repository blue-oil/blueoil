...
def resnet_graph_18(input_image, train_bn=True, config=None):
    ...
    # Stage 2
    x = conv_block_18(x, 3, [16, 64], stage=2, block='a', strides=(1, 1), train_bn=train_bn, config=config)
    C2 = x = identity_block_18(x, 3, [16, 64], stage=2, block='b', train_bn=train_bn, config=config)
    # Stage 3
    x = conv_block_18(x, 3, [32, 128], stage=3, block='a', train_bn=train_bn, config=config)
    C3 = x = identity_block_18(x, 3, [32, 128], stage=3, block='b', train_bn=train_bn, config=config)
    # Stage 4
    x = conv_block_18(x, 3, [64, 256], stage=4, block='a', train_bn=train_bn, config=config)
    C4 = x = identity_block_18(x, 3, [64, 256], stage=4, block='b', train_bn=train_bn, config=config)
    # Stage 5
    x = conv_block_18(x, 3, [128, 512], stage=5, block='a', train_bn=train_bn, config=config)
    C5 = x = identity_block_18(x, 3, [128, 512], stage=5, block='b', train_bn=train_bn, config=config)
