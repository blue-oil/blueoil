...
def max_unpool_with_argmax(x, argmax, ksize, data_format='NHWC'):
    ...
    Args:
        ...
        ksize(list, tuple): Size of the max pooling window.
    ...
    def _forward(x, argmax, ksize):
        ...
        def _func(
            ...
            Args:
                ...
                argmax(tf.Variable): The argmax from tf.nn.max_pool_with_argmax which has same shape with inputs.
                inputs_shape(list, tuple): Shape of inputs.
                ksize(list, tuple): The size of the window for each dimension of the inputs.
            Returns:
                tf.Variable: An unpooled tensor.
            """
