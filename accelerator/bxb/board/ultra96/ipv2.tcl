...
set_property ip_repo_paths "./rtl" [current_project]
update_ip_catalog
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ENABLE_PIPELINE {1} \
   CONFIG.C_MODE {0} \
 ] $amm_axi_bridge_0

  # Create instance: amm_axi_bridge_1, and set properties
  set amm_axi_bridge_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:amm_axi_bridge:1.0 amm_axi_bridge_1 ]
  set_property -dict [ list \
   CONFIG.C_AVA_DATA_WIDTH {128} \
   CONFIG.C_ENABLE_PIPELINE {1} \
   CONFIG.C_MODE {1} \
 ] $amm_axi_bridge_1

  # Create instance: amm_axi_bridge_2, and set properties
  set amm_axi_bridge_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:amm_axi_bridge:1.0 amm_axi_bridge_2 ]
  set_property -dict [ list \
   CONFIG.C_AVA_DATA_WIDTH {64} \
   CONFIG.C_ENABLE_PIPELINE {1} \
   CONFIG.C_MODE {0} \
  ...
  # Create instance: amm_axi_bridge_3, and set properties
  set amm_axi_bridge_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:amm_axi_bridge:1.0 amm_axi_bridge_3 ]
  set_property -dict [ list \
   CONFIG.C_AVA_DATA_WIDTH {64} \
   CONFIG.C_ENABLE_PIPELINE {1} \
   CONFIG.C_MODE {1} \
  ...
  # Create instance: amm_axi_bridge_4, and set properties
  set amm_axi_bridge_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:amm_axi_bridge:1.0 amm_axi_bridge_4 ]
  set_property -dict [ list \
   CONFIG.C_AVA_DATA_WIDTH {32} \
   CONFIG.C_ENABLE_PIPELINE {1} \
   CONFIG.C_MODE {0} \
 ] $amm_axi_bridge_4
  ...
  # Create instance: bxb_ip_0, and set properties
  set bxb_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:bxb_ip:1.0 bxb_ip_0 ]
  ...
  connect_bd_intf_net -intf_net amm_axi_bridge_0_M_AXI [get_bd_intf_pins amm_axi_bridge_0/M_AXI] [get_bd_intf_pins axi_interconnect_1/S00_AXI]
  connect_bd_intf_net -intf_net amm_axi_bridge_1_M_AXI [get_bd_intf_pins amm_axi_bridge_1/M_AXI] [get_bd_intf_pins axi_interconnect_1/S01_AXI]
  connect_bd_intf_net -intf_net amm_axi_bridge_2_M_AXI [get_bd_intf_pins amm_axi_bridge_2/M_AXI] [get_bd_intf_pins axi_interconnect_1/S02_AXI]
  connect_bd_intf_net -intf_net amm_axi_bridge_3_M_AXI [get_bd_intf_pins amm_axi_bridge_3/M_AXI] [get_bd_intf_pins axi_interconnect_1/S03_AXI]
  connect_bd_intf_net -intf_net amm_axi_bridge_4_M_AXI [get_bd_intf_pins amm_axi_bridge_4/M_AXI] [get_bd_intf_pins axi_interconnect_1/S04_AXI]
  connect_bd_intf_net -intf_net axi_amm_bridge_0_M_AVALON [get_bd_intf_pins axi_amm_bridge_0/M_AVALON] [get_bd_intf_pins bxb_ip_0/bxb_csr]
  ...
  connect_bd_intf_net -intf_net bxb_ip_0_bxb_adma [get_bd_intf_pins amm_axi_bridge_0/Avalon_S0] [get_bd_intf_pins bxb_ip_0/bxb_adma]
  connect_bd_intf_net -intf_net bxb_ip_0_bxb_fdma [get_bd_intf_pins amm_axi_bridge_1/Avalon_S0] [get_bd_intf_pins bxb_ip_0/bxb_fdma]
  connect_bd_intf_net -intf_net bxb_ip_0_bxb_qdma [get_bd_intf_pins amm_axi_bridge_2/Avalon_S0] [get_bd_intf_pins bxb_ip_0/bxb_qdma]
  connect_bd_intf_net -intf_net bxb_ip_0_bxb_rdma [get_bd_intf_pins amm_axi_bridge_3/Avalon_S0] [get_bd_intf_pins bxb_ip_0/bxb_rdma]
  connect_bd_intf_net -intf_net bxb_ip_0_bxb_wdma [get_bd_intf_pins amm_axi_bridge_4/Avalon_S0] [get_bd_intf_pins bxb_ip_0/bxb_wdma]
  ...
  connect_bd_net -net rst_ps8_0_99M_interconnect_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins rst_ps8_0_99M/interconnect_aresetn]
  connect_bd_net -net rst_ps8_0_99M_mb_reset [get_bd_pins bxb_ip_0/bxb_reset] [get_bd_pins rst_ps8_0_99M/mb_reset]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins amm_axi_bridge_0/aresetn] [get_bd_pins amm_axi_bridge_1/aresetn] [get_bd_pins amm_axi_bridge_2/aresetn] [get_bd_pins amm_axi_bridge_3/aresetn] [get_bd_pins amm_axi_bridge_4/aresetn] [get_bd_pins axi_amm_bridge_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins axi_interconnect_1/S02_ARESETN] [get_bd_pins axi_interconnect_1/S03_ARESETN] [get_bd_pins axi_interconnect_1/S04_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins amm_axi_bridge_0/clk] [get_bd_pins amm_axi_bridge_1/clk] [get_bd_pins amm_axi_bridge_2/clk] [get_bd_pins amm_axi_bridge_3/clk] [get_bd_pins amm_axi_bridge_4/clk] [get_bd_pins axi_amm_bridge_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins axi_interconnect_1/S02_ACLK] [get_bd_pins axi_interconnect_1/S03_ACLK] [get_bd_pins axi_interconnect_1/S04_ACLK] [get_bd_pins bxb_ip_0/bxb_clock] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces bxb_ip_0/bxb_adma] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces bxb_ip_0/bxb_fdma] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces bxb_ip_0/bxb_qdma] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces bxb_ip_0/bxb_rdma] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces bxb_ip_0/bxb_wdma] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_zynq_ultra_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x00001000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs bxb_ip_0/bxb_csr/Reg] SEG_bxb_ip_0_Reg
...
generate_target all [get_files  $root/myproj/project_1.srcs/sources_1/bd/design_1/design_1.bd]
create_ip_run [get_files -of_objects [get_fileset sources_1] $root/myproj/project_1.srcs/sources_1/bd/design_1/design_1.bd]
launch_runs -jobs 4 {design_1_amm_axi_bridge_0_0_synth_1 design_1_amm_axi_bridge_1_0_synth_1 design_1_amm_axi_bridge_2_0_synth_1 design_1_amm_axi_bridge_3_0_synth_1 design_1_amm_axi_bridge_4_0_synth_1 design_1_axi_amm_bridge_0_0_synth_1 design_1_bxb_ip_0_0_synth_1 design_1_rst_ps8_0_99M_0_synth_1 design_1_zynq_ultra_ps_e_0_0_synth_1 design_1_xbar_0_synth_1 design_1_s00_mmu_0_synth_1 design_1_s01_mmu_0_synth_1 design_1_s02_mmu_0_synth_1 design_1_s03_mmu_0_synth_1 design_1_s04_mmu_0_synth_1 design_1_auto_us_3_synth_1 design_1_auto_us_2_synth_1 design_1_auto_us_1_synth_1 design_1_auto_us_0_synth_1 design_1_auto_ds_0_synth_1 design_1_auto_pc_0_synth_1}


wait_on_run design_1_bxb_ip_0_0_synth_1 
wait_on_run design_1_amm_axi_bridge_0_0_synth_1 
wait_on_run design_1_amm_axi_bridge_1_0_synth_1 
wait_on_run design_1_amm_axi_bridge_2_0_synth_1 
wait_on_run design_1_amm_axi_bridge_3_0_synth_1 
wait_on_run design_1_amm_axi_bridge_4_0_synth_1 
wait_on_run design_1_axi_amm_bridge_0_0_synth_1 
wait_on_run design_1_rst_ps8_0_99M_0_synth_1 
...
wait_on_run design_1_s01_mmu_0_synth_1 
wait_on_run design_1_s02_mmu_0_synth_1 
wait_on_run design_1_s03_mmu_0_synth_1 
wait_on_run design_1_s04_mmu_0_synth_1 
wait_on_run design_1_auto_us_3_synth_1 
wait_on_run design_1_auto_us_2_synth_1 
...
# Create HDL wrapper
make_wrapper -files [get_files $root/myproj/project_1.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse $root/myproj/project_1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v

# Run synthesis till generate bitstream
launch_runs impl_1 -to_step write_bitstream -jobs 4
wait_on_run impl_1

# Export bitstream
file copy -force $root/myproj/project_1.runs/impl_1/design_1_wrapper.bit $root/bin/ipv2.bit

#bootgen -image ipv2.bif  -arch zynqmp -w -o ipv2.bin
