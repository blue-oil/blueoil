...
set_instance_parameter_value hps_0 {F2SDRAM_Type} {Avalon-MM\ Read-Only Avalon-MM\ Read-Only Avalon-MM\ Write-Only Avalon-MM\ Read-Only Avalon-MM\ Write-Only}
set_instance_parameter_value hps_0 {F2SDRAM_Width} {64 32 128 64 64}
...
add_connection bxb_1.adma hps_0.f2h_sdram0_data
set_connection_parameter_value bxb_1.adma/hps_0.f2h_sdram0_data arbitrationPriority {1}
set_connection_parameter_value bxb_1.adma/hps_0.f2h_sdram0_data baseAddress {0x0000}
set_connection_parameter_value bxb_1.adma/hps_0.f2h_sdram0_data defaultConnection {0}

add_connection bxb_1.fdma hps_0.f2h_sdram2_data
set_connection_parameter_value bxb_1.fdma/hps_0.f2h_sdram2_data arbitrationPriority {1}
set_connection_parameter_value bxb_1.fdma/hps_0.f2h_sdram2_data baseAddress {0x0000}
set_connection_parameter_value bxb_1.fdma/hps_0.f2h_sdram2_data defaultConnection {0}

add_connection bxb_1.qdma hps_0.f2h_sdram3_data
set_connection_parameter_value bxb_1.qdma/hps_0.f2h_sdram3_data arbitrationPriority {1}
set_connection_parameter_value bxb_1.qdma/hps_0.f2h_sdram3_data baseAddress {0x0000}
set_connection_parameter_value bxb_1.qdma/hps_0.f2h_sdram3_data defaultConnection {0}

add_connection bxb_1.rdma hps_0.f2h_sdram4_data
set_connection_parameter_value bxb_1.rdma/hps_0.f2h_sdram4_data arbitrationPriority {1}
set_connection_parameter_value bxb_1.rdma/hps_0.f2h_sdram4_data baseAddress {0x0000}
set_connection_parameter_value bxb_1.rdma/hps_0.f2h_sdram4_data defaultConnection {0}

add_connection bxb_1.wdma hps_0.f2h_sdram1_data
set_connection_parameter_value bxb_1.wdma/hps_0.f2h_sdram1_data arbitrationPriority {1}
set_connection_parameter_value bxb_1.wdma/hps_0.f2h_sdram1_data baseAddress {0x0000}
set_connection_parameter_value bxb_1.wdma/hps_0.f2h_sdram1_data defaultConnection {0}

add_connection clk_0.clk pll_0.refclk

add_connection clk_0.clk_reset bxb_1.reset

add_connection clk_0.clk_reset pll_0.reset

add_connection hps_0.h2f_lw_axi_master bxb_1.csr
set_connection_parameter_value hps_0.h2f_lw_axi_master/bxb_1.csr arbitrationPriority {1}
set_connection_parameter_value hps_0.h2f_lw_axi_master/bxb_1.csr baseAddress {0x0000}
set_connection_parameter_value hps_0.h2f_lw_axi_master/bxb_1.csr defaultConnection {0}

add_connection pll_0.outclk0 bxb_1.clock

add_connection pll_0.outclk0 hps_0.f2h_sdram0_clock

add_connection pll_0.outclk0 hps_0.f2h_sdram1_clock

add_connection pll_0.outclk0 hps_0.f2h_sdram2_clock

add_connection pll_0.outclk0 hps_0.f2h_sdram3_clock

add_connection pll_0.outclk0 hps_0.f2h_sdram4_clock
