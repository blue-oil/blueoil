...
def run(experiment_id,
    ...
    project_dir = os.path.join(export, project_dir_name)
...
def main(experiment_id, restore_path, image_size, project_name):
    run(experiment_id, restore_path, image_size, project_name)
