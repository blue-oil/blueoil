...
@click.option(
    "--save_npy_for_debug",
    is_flag=True,
    help="Flag of saving npy file for debugging. Default is False.",
    default=False,
)
def convert(experiment_id, checkpoint, template, image_size, project_name, save_npy_for_debug):
    export_output_root_dir = run_convert(experiment_id, checkpoint, template, image_size, project_name, save_npy_for_debug)
