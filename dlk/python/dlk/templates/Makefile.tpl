...
lm_aarch64:          FLAGS += $(INCLUDES) -std=c++0x -O3 -DUSE_NEON -DUSE_PNG -pthread -g -fopenmp=libiomp5 --target=aarch64-linux-gnu -I/usr/local/clang+llvm-7.0.0-aarch64-linux-gnu/include/c++/v1/ -I/usr/local/clang+llvm-7.0.0-aarch64-linux-gnu/lib/clang/7.0.0/include/ -L/usr/local/clang+llvm-7.0.0-aarch64-linux-gnu/lib/ -fuse-ld=/usr/local/clang+llvm-7.0.0-x86_64-linux-gnu-ubuntu-16.04/bin/ld.lld -flto=thin -Wl,--lto-O3 -stdlib=libc++ -lc++abi -static -Wno-everything
