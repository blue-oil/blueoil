...
void intel_hls_qconv(unsigned k_w,
                     unsigned k_h,
                     T_q in_data_packed[],
                     T_out out_data[],
                     T_q k_data_packed[],
...
void intel_hls_qgemm(T_q A_packed[],
                     T_q B_packed[],
                     T_out Y[],
                     type::u32 a_row,
                     type::u32 a_col_by_word,
                     type::u32 b_col,
                     type::u32 nbits_a,
                     type::u32 nbits_b)
{
...
void intel_hls_qconv_with_kn2row(T_q in_data_packed[],
                                 T_out out_data[],
                                 T_q k_data_packed[],
                                 T_out th_data[],
                                 unsigned in_w,
...
void intel_hls_a8w1_qconv_with_kn2row(T_in_k2c in_data[],
                                      T_out_k2c out_data[],
                                      T_k_k2c k_data[],
                                      unsigned in_w,
                                      unsigned in_h,
