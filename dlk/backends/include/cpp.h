...
void conv_kn2row_tiling(T_in in_data[], T_out out_data[], T_k k_data[],
                        ...
                        const unsigned in_h, const unsigned in_c,
                        const unsigned out_w, const unsigned out_h,
                        const unsigned out_c, const unsigned pad,
                        const unsigned stride) {
  assert(((KH == 3) && (KW == 3)) || ((KH == 1) && (KW == 1)));
  assert(((KH == 3) && (pad == 1)) || ((KH == 1) && (pad == 0)));
  assert(stride == 1);
...
void qconv_kn2row_tiling(T_q in_data_packed[], T_out out_data[],
                         T_q k_data_packed[], T_out threshold_data[],
                         const unsigned in_w, const unsigned in_h,
                         const unsigned in_c_by_word, const unsigned in_b,
                         const unsigned out_w, const unsigned out_h,
                         const unsigned out_c, const unsigned pad,
                         const unsigned stride) {
  assert(((KH == 3) && (KW == 3)) || ((KH == 1) && (KW == 1)));
  ...
  qconv_kn2row_tiling_impl(in_data_packed, out_data, k_data_packed,
                           threshold_data, in_w, in_h, in_c_by_word, in_b,
