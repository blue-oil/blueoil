...
void qconv1x1_impl(T_q in_data_packed[],
                   T_out out_data[],
                   T_q k_data_packed[],
                   unsigned in_w,
                   unsigned in_h,
...
template <int KH, int KW>
void qconv_with_kn2row(T_q in_data_packed[],
                       T_out out_data[],
                       T_q k_data_packed[],
                       T_out threshold_data[],
                       unsigned in_w,
...
void a8w1_conv3x3_impl(T_in_k2c in_data[],
                       T_out_k2c out_data[],
                       T_k_k2c k_data[],
                       unsigned in_w,
                       unsigned in_h,
...
void a8w1_conv3x3_with_kn2row_impl(T_in_k2c in_data[],
                                   T_out_k2c out_data[],
                                   T_k_k2c k_data[],
...
template <int KH, int KW>
void a8w1_conv(T_in_k2c in_data[],
               T_out_k2c out_data[],
               T_k_k2c k_data[],
               unsigned in_w,
               unsigned in_h,
...
template <int KH, int KW>
void a8w1_conv3x3_with_kn2row(T_in_k2c in_data[],
                              T_out_k2c out_data[],
                              T_k_k2c k_data[],
                              unsigned in_w,
                              unsigned in_h,
