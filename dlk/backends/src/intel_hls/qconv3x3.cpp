...
void intel_hls_qconv3x3_impl(
  hls_avalon_slave_register_argument ihc::mm_master<T_in_hls, ihc::aspace<1>, ihc::awidth<32>, ihc::dwidth<NBITS_BW_IN>, ihc::latency<0>, ihc::maxburst<32>, ihc::align<32>, ihc::waitrequest<true> > &in_data,
  hls_avalon_slave_register_argument ihc::mm_master<T_out_hls, ihc::aspace<2>, ihc::awidth<32>, ihc::dwidth<NBITS_BW_OUT>, ihc::latency<0>, ihc::maxburst<32>, ihc::align<32>, ihc::waitrequest<true> > &out_data,
  hls_avalon_slave_register_argument ihc::mm_master<T_k_hls, ihc::aspace<3>, ihc::awidth<32>, ihc::dwidth<NBITS_BW_K>, ihc::latency<0>, ihc::maxburst<32>, ihc::align<32>, ihc::waitrequest<true> > &k_data,
  hls_avalon_slave_register_argument uint32 in_w,
  hls_avalon_slave_register_argument uint32 in_h,
  hls_avalon_slave_register_argument uint32 in_c_by_word,
  hls_avalon_slave_register_argument uint32 out_w,
  hls_avalon_slave_register_argument uint32 out_h,
  hls_avalon_slave_register_argument uint32 out_c,
  hls_avalon_slave_register_argument uint32 out_c_offset)
{
  ...
  {
    hls_memory
    hls_singlepump hls_bankbits(0, 1, 2)
    ...
    hls_register
    T_in_hls in_reg[p::k_h][p::k_w][p::max_in_c_by_word][p::nbits_in_data];

    hls_memory
    hls_singlepump hls_bankbits(0, 1, 2, 3, 4, 5)
      ...
      for (unsigned kw = 0; kw < p::k_w; kw++) {
        ...
        for (unsigned kc = 0; kc < in_c_by_word; kc++) {
          ...
          for (unsigned kn = 0; kn < p::num_pe; kn++) {
            k_local[kh][kw][kc][kn] = (T_in_hls) k_data[idx_k++];
          }
        }
      }
    }
