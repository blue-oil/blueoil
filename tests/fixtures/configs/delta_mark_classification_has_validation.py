...
DATASET_CLASS = type('DATASET_CLASS', (ClassificationBase,), {'extend_dir': 'custom_delta_mark_classification/for_train', 'validation_extend_dir': 'custom_delta_mark_classification/for_validation'})

IMAGE_SIZE = [128, 128]
BATCH_SIZE = 1
DATA_FORMAT = "NHWC"
TASK = Tasks.CLASSIFICATION
CLASSES = ['rose', 'sunflower', 'other']
