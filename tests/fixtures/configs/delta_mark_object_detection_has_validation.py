...
DATASET_CLASS = type('DATASET_CLASS', (ObjectDetectionBase,), {'extend_dir': 'custom_delta_mark_object_detection/for_train', 'validation_extend_dir': 'custom_delta_mark_object_detection/for_validation'})
