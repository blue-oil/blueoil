...
DATASET_CLASS = type('DATASET_CLASS', (OpenImagesV4BoundingBoxBase,), {'extend_dir': 'custom_open_images_v4_bounding_boxes/for_train', 'validation_extend_dir': 'custom_open_images_v4_bounding_boxes/for_validation'})

IMAGE_SIZE = [128, 128]
BATCH_SIZE = 1
DATA_FORMAT = "NHWC"
TASK = Tasks.OBJECT_DETECTION
CLASSES = ['Person', 'Dairy', 'Table', 'Cake', 'Pastry', 'Building', 'Window', 'Woman', 'Car', 'Taxi', 'Humaneye', 'Shirt', 'Humanmouth', 'Humanear', 'Humanhair', 'Humanhead', 'Man', 'Humanface', 'Humanarm', 'Glasses', 'Humanhand', 'Tie', 'Suit', 'Tree', 'Bronzesculpture', 'Boat', 'Streetlight', 'Shotgun', 'Helmet', 'Airplane', 'Food', 'Fruit', 'Sportsequipment', 'Clothing', 'Footwear', 'Humanleg', 'Mammal', 'Trousers', 'Dog', 'Vegetable', 'Juice', 'Wheel', 'Boy', 'Humanbody']
