...
DATASET_CLASS = type('DATASET_CLASS', (CamvidCustom,), {'extend_dir': 'camvid_custom', 'validation_extend_dir': 'camvid_custom'})

IMAGE_SIZE = [128, 128]
BATCH_SIZE = 1
DATA_FORMAT = "NHWC"
TASK = Tasks.SEMANTIC_SEGMENTATION
CLASSES = ['Sky', 'Building', 'Column_Pole', 'Sidewalk', 'Tree', 'SignSymbol', 'Fence', 'Car', 'Pedestrian', 'Bicyclist']
